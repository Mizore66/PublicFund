...
export default function CreatePage() {
  const { user, status, startKycVerification } = useWalletAuth()
          ...
          <div className="container px-4 md:px-6 relative">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-foreground/80 md:text-xl">
                  Complete KYC verification to create a project and receive funding
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container px-4 md:px-6">
            <Card className="web3-card max-w-md mx-auto">
              <CardHeader>
                ...
                <CardDescription className="text-foreground/70">
                  Please complete KYC verification to create a project
                </CardDescription>
              </CardHeader>
              <CardContent className="flex flex-col items-center justify-center py-8">
                <div className="rounded-full bg-yellow-500/20 p-4 mb-4">
                ...
                <h3 className="text-xl font-medium mb-2">Verification Needed</h3>
                <p className="text-center text-foreground/70 mb-6">
                  You need to complete KYC verification to create a project and receive funding.
                </p>
                <Button className="web3-button" onClick={startKycVerification}>
